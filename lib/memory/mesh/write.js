 ...
 * @private
 */
export function _validateMetadata(_mesh, metadata) {
 ...
 * @private
 */
export function _sanitizeContent(_mesh, content) {
 ...
 * @private
 */
export function _splitParagraphSpans(_mesh, content, minChars, maxChars) {
    const spans = [];
    const paraRegex = /\n\n+/g;
    const paraStarts = [0];
    let m;
