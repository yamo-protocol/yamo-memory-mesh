 ...
 */
export async function distillLesson(mesh, context) {
    await mesh.init();
 ...
 */
export async function queryLessons(mesh, query = "", options = {}) {
    await mesh.init();
 ...
 */
export async function getMemoriesByPattern(mesh, patternId) {
    await mesh.init();
    if (!mesh.client)
        return [];
